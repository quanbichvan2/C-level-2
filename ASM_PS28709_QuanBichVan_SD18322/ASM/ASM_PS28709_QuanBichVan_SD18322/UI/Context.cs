...
namespace ASM_PS28709_QuanBichVan_SD18322.UI
{
    public class Context
    {
        ...
        public static int Menu()
        {
            ...
            string menu = @"
                    ...
                    ||     `--'   `--'  `------'`--'  `--'   `-----'        ||
                    ||  --------------------------------------------------  ||
                    ||    1. Tạo lớp và nhập danh sách sinh viên:           ||
                    ||    2. Xuất danh sách sinh viên:                      ||
                    ||    3. Tìm Kiếm ds sinh viên theo điểm min & max      ||
                    ||    4. Tìm sv theo StId và cập nhật thông tin sv:     ||
                    ||    5 .Xuất sv theo thứ tự điểm từ cao tới thấp:      ||
                    ||    6. Xuất 5 sinh viên có điểm cao nhất              ||
                    ||    7. Tạo thread ra text ASMC#2.txt                  ||
