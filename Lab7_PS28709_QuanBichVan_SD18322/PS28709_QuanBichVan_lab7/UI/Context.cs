...
namespace PS28709_QuanBichVan_lab7.UI
{
    public class Contexts
    {
        ...
        public static int Menu()
        {
            ...
            string menu = @"
                    ...
                    ||   `--'   `--'  `------'`--'  `--'   `-----'      ||
                    ||--------------------------------------------------||
                    ||  1. Xuất bình phương các số chẵn > 4.            ||
                    ||  2. Xuất số lần xuất hiện từng ký tự trong chuỗi ||
                    ||  3. xuất ra màn hình các chuỗi con được viết hoa ||
                    ||  4. Xuất các thông tin ContactName trong table   ||
                    ||     Customers và ShipName trong bảng Orders      ||
                    ||  5. Thêm dòng vào bảng Customers với dữ liệu     ||
                    ||     CustomerID =”Fpoly” và CompanyName = “FPT”   ||
                    ||  6. Update CompanyName = “FE”,CustomerID =”Fpoly”||
                    ||  7. Xóa dòng có CustumerID =” ALFKI”             ||
